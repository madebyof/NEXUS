...
export default function Sidebar ({ pulsePhase, onClose }: SidebarProps) {
  const navItems = [
  ...
  return (
    <div className=" left-0 top-0 bottom-0 w-[320px] backdrop-blur-xl bg-gradient-to-br from-[#000000CC] via-[#0A0A1ECC] to-[#000000CC] border-r-[1px] border-[#00FFFF33] transition-all duration-500 overflow-hidden max-sm:w-[280px]">
          ...
          <div className="flex items-center gap-4">
            <div className="relative w-14 h-14">
              ...
              <div className="absolute inset-[2px] bg-[#000000] rounded-full flex items-center justify-center">
                <svg className="w-7 h-7 text-[#00FFFF]" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1">
              ...
              <p className="text-[11px] text-[#00FFFF88] tracking-[0.2em]">NEURAL NETWORK</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2">
          {navItems.map((item, index) => (
            <a
              key={index}
              href={item.link}
              className="block px-4 py-3 rounded-lg text-[12px] text-[#00FFFF88] hover:text-[#00FFFF] hover:bg-[#00FFFF11] transition-all cursor-pointer font-semibold tracking-[0.1em]"
            >
              {item.name}
            </a>
          ))}
        ...
        <div className="p-4 border-t border-[#00FFFF33]">
          <div className="relative p-4 rounded-lg overflow-hidden">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-[13px] font-semibold text-[#00FFFF]">Odalric FASSINOU</p>
                <p className="text-[10px] text-[#00FFFF88] tracking-[0.15em]">CHIEF OPERATOR</p>
              </div>
